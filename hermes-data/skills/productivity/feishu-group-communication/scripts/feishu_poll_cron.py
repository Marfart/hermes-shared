...
# ⚠️ APP_SECRET 不要手写！从 feishu_send.py 复制
import urllib.request, json, os, sys

APP_ID = "cli_aaa7c346a6385cba"
APP_SECRET="COPY_F...D_PY"  # 从 feishu_send.py 复制真实值
CHAT_ID = "oc_1a238a6016460ec51c602048a88aca70"
XIAOMA_APP_ID = "cli_aaa7c6b5c2389cfc"
KALI_OPEN_ID = "ou_ee63858e3a997e994faec6e4647c552c"
...
def parse_msg(msg):
    ...
    try:
        ...
        if msg_type == "text":
            ...
            # 兼容两种格式：{zh_cn:{content:...}} 和 {content:...}
            ...
            for row in content:
                for node in row:
                    if node.get("tag") == "text":
                        ...
                        # user_id 可能是 @_user_1 占位符，优先用 user_name
